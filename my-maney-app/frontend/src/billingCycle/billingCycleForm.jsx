...
class BillingCycleForm extends Component {
    ...
    render(){
        ...
        const {sumOfCredts, sumOfDebts} = this.calculateSumary()
        ...
        return (
            <form role='form' onSubmit={handleSubmit}>
                <div className='box-body' >
                    ...
                    <ItemList cols='12 6' list={credits} readOnly={this.readOnly} 
                        field='credits' legend='Céditos2'/>
                    <ItemList cols='12 6' list={debts} readOnly={this.readOnly} 
